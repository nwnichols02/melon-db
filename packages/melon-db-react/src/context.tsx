 ...
 */
export function MelonDbProvider({ db, children }: MelonDbProviderProps): React.ReactElement {
 ...
 */
export function useDatabase<Schema extends MelonSchema = MelonSchema>(): MelonDatabase<Schema> {
