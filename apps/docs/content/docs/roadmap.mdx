...
This page is the **living status** for Melon-db. Update it when features land or deferrals change. For product vision see [About Melon-db](/docs/about). For requirement-by-requirement PRD tracking see [PRD compliance](/docs/prd-compliance).
...
| **Alpha / open-source release** | npm `@melon-db` org, public GitHub, LICENSE/SECURITY, publish CI — see [PRD compliance — Alpha release](/docs/prd-compliance#alpha-release-and-open-source-prd-1) |
