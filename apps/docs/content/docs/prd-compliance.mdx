...
Pre-GA work required before publishing `@melon/*` to npm and opening the GitHub repository. Phase 34 implements the release engineering and adoption plumbing; a couple items remain **manual** (npm org creation + flipping GitHub public).
...
| npm org `@melon` | Gap | Manual: create org, invite maintainers, enforce **2FA** |
