...
- React Native on-device comparison in this harness — use the manual checklist in [`@melon/db-sqlite-native` README](https://github.com/melon/melon/blob/main/packages/melon-db-sqlite-native/README.md) (insert 10k on iOS `jsi-sync` vs `turbo`)
