...
Phase 28 adds a **dev-only benchmark screen** in `apps/playground-rn-dev` that reuses the same scenarios via [`@melon/db-sqlite/bench`](../../packages/melon-db-sqlite/src/bench/index.ts).
