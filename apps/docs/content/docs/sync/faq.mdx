...
The pull/push **shape** is Watermelon-compatible (`changes` grouped by table, `lastPulledAt`, schema version). You still need to map Melon-db field names and wire Melon-db’s outbox — see the [migration guide](/docs/migration).
