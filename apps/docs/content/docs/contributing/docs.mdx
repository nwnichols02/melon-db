...
7. If benchmark scenarios change, update [performance comparison](/docs/performance-comparison), run `bun run bench:compare:docs`, commit `apps/docs/src/data/bench-compare-latest.json`, and update [`packages/melon-db-sqlite/README.md`](https://github.com/nwnichols02/melon-db/blob/main/packages/melon-db-sqlite/README.md).
...
See [`.cursor/phases/docs-fumadocs.md`](https://github.com/nwnichols02/melon-db/blob/main/.cursor/phases/docs-fumadocs.md) for exit criteria and ongoing doc rules.

## Agent / Cursor

- Repo guide: [`AGENTS.md`](https://github.com/nwnichols02/melon-db/blob/main/AGENTS.md)
