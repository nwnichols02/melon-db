---
title: Documentation
description: How to keep Melon-db docs up to date.
---
...
7. If benchmark scenarios change, update [performance comparison](/docs/performance-comparison), run `bun run bench:compare:docs`, commit `apps/docs/src/data/bench-compare-latest.json`, and update [`packages/melon-db-sqlite/README.md`](https://github.com/nwnichols02/melon/blob/main/packages/melon-db-sqlite/README.md).
...
TypeDoc runs **once per package** with a scoped title (`@melon-db/db API Reference`). Shared metadata lives in `apps/docs/scripts/api-package-meta.ts`. To add a package to the API sidebar, extend `API_PACKAGES` there and in `content/docs/api/meta.json`, then run `bun run docs:api`.
...
See [`.cursor/phases/docs-fumadocs.md`](https://github.com/nwnichols02/melon/blob/main/.cursor/phases/docs-fumadocs.md) for exit criteria and ongoing doc rules.

## Agent / Cursor

- Repo guide: [`AGENTS.md`](https://github.com/nwnichols02/melon/blob/main/AGENTS.md)
- Melon-db dev skill: `.cursor/skills/melon-dev/SKILL.md`
