...
<ArchitectureDiagram
  alt="Native SQLite path decision — Expo Go vs dev build with JSI and TurboModule fallback"
  src="/diagrams/architecture/native-path-decision.svg"
/>
...
<ArchitectureDiagram
  alt="Native SQLite stack — JavaScript bridge, TurboModule codegen, C++ JSI host object"
  src="/diagrams/architecture/native-stack-layers.svg"
/>
