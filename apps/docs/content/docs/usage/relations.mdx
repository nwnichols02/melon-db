...
Relations are declared in [schema metadata](/docs/setup/schema). Melon-db stores foreign keys as ordinary fields; relations describe how collections link together for validation and query `include`.
