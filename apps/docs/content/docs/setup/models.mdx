...
[`@melon/db-prisma`](/docs/packages/melon-db-prisma) can import a Prisma schema and generate model interfaces plus a local client facade. The runtime engine remains `@melon/db`; generated types are a DX layer only.
